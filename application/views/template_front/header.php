	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	    <div class="navbar-nav">
	      ...
	      <a class="nav-item nav-link mr-3" href="#inbox">Inbox</a>
...
<!-- <img src="<?= base_url('assets/images/buku1.jpg') ?>"> -->
	<div class="jumbotron" style="background: url('img/bg_buku1.jpg');">
		
		<div class="container">

	  <h1 class="display-4 text-white">Selamat Datang di <b>MyBook</b></h1>
	  ...
	  <a class="btn btn-outline-success btn-md" href="<?=base_url('koleksi')?>" role="button">Ayo Mulai</a>
	  </div>
	</div>
</section>
