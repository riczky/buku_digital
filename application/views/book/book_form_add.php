    ...
    <section class="content">
        ...
        <div class="box">
          ...
          <div class="box-body">
              ...
              <?php echo form_open_multipart('book/prosesAdd');?>
                  <div class="form-group <?=form_error('id_buku')? 'has-error' : null?>">
                     <label for="id_buku">Id Buku *</label>
                     <input class="form-control" type="text" name="id_buku" id="id_buku" value="<?=set_value('id_buku')?>"><?=form_error('id_buku')?>
                   </div>
                   <div class="form-group <?=form_error('file_buku')? 'has-error' : null?>">
                     <label for="file_buku">File Buku*</label>
                     <input class="form-control" type="file" name="file_buku" id="file_buku" value="<?=set_value('file_buku')?>"><?=form_error('file_buku')?>
